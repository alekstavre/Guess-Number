...
<div class="container">
    ...
    <div class="card bg-light mb-3">
        <div class="card-body">
            <p class="card-text">Guess the computer generated random number
                between 1
                and 1000.
            </p>
        </div>
    ...
    <div>
        ...
        <button (click)="verifyGuess()" class="btn btn-primary btnsm">
            Verify</button>
        <button (click)="initializeGame()" class="btn btn-warning btnsm">
            Restart</button>
    </div>
    <div>
        <p *ngIf="deviation<0" class="alert alert-warning">Your guess is higher.
        </p>
